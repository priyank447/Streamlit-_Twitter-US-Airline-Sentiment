...
choice = st.sidebar.multiselect('Pick airkines',('US airways', 'United', 'American', 'Southwest', 'Delta', 'Virgin America'), key=0)
...
if not st.sidebar.checkbox("close",True, key='3'):
    st.header('word Cloudfor %s Sentiment' % (word_sentiment))
